...
export class AswFormBuilder implements OnInit, OnChanges {
    ...
    ngOnChanges(): void {
        if (this.uploadData.length) {
            ...
            console.log("pass uploadData from home and asign to formContainer ", this.formContainer)
        }
    }

    drop(event: CdkDragDrop<string[]>): void {
        console.log("enter drop method")
        console.log("event holds information about the drag and drop operation: ", event)
        console.log("formContainer holds the data before drag and drop: ", this.formContainer)
        ...
        console.log("formContainer holds the data after drag and drop: ", this.formContainer)
    }
